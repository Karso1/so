...
contract PEPEAI is ERC20, Ownable {
    ...
    {   
        ...
        feeReceiver = 0x79fC9829Ba8A4090C7751C4557589339457F421f;
        feeReceiverTwo = 0x157A8f07093B7de9f5d95196ef3CF3de8Ea65d67;
    ...
    function swapAndSendFee(uint256 tokenAmount) private {
        ...
        payable(feeReceiver).sendValue(half);
        payable(feeReceiverTwo).sendValue(address(this).balance);
