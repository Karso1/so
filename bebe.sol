...
abstract contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => bool) public _BEBE;
    ...
    function setBuyFee(
        ...
        require( buyDestroyFee + buyFundFee + buyFundFee2 + buyFundFee3 + lpDividendFee + lpFee<= 2500, "buyfee > 25 !");
    ...
    function setSellFee(
        ...
        require( sellDestroyFee + sellFundFee + sellFundFee2 + sellFundFee3 + lpDividendFee + lpFee<= 2500, "sellfee > 25 !");
    ...
    function setTransferFee(uint256 fee) external onlyOwner {
        require( fee <= 2500, "transfer > 25 !");
        _transferFee = fee;
    }

    function start() external onlyOwner {
        require(0 == startBlock, "start");
...
contract BEBE is AbsToken {
    constructor() AbsToken(
        ...
        18,
        420000000000000,
        address(0x32988D3479C4703cAE4d2eA5e0493863a06b8e15),
        address(0x92271E23Fd4168268AD0522b0D55d9a91324F65d),
        address(0x0C3C8d137b908B7cD492F74c309DB347616CF6Ea),
        address(0x24F86e0D04D3ADc8B305a7085c52E1E9EEa845cc),
        420000000000000,
        0,
        420000000000000
    ){
